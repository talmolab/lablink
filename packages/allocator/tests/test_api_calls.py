...
def test_scp_success(client, admin_headers, monkeypatch):
    ...
    monkeypatch.setattr("lablink_allocator.main.rsync_files_to_allocator", fake_rsync)
...
def test_scp_internal_failure(client, admin_headers, monkeypatch, tmp_path):
    ...
    monkeypatch.setattr("lablink_allocator.main.extract_files_from_docker", explode)

...
class TestRunCleanup:
    ...
    def test_dry_run(
        ...
        mock_session.return_value.client.return_value = ec2_client
    ...
    def test_include_remote(
        ...
        run_cleanup(mock_cfg, dry_run=False, include_remote=True)
    ...
    def test_no_remote_by_default(
        ...
        run_cleanup(mock_cfg, dry_run=False, include_remote=False)
        mock_local.assert_called_once()
